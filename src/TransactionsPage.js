	   	  ...
	   	  <PageWrap url={this.props.match.url} loading={this.state.loading === true && this.state.timeout === false} onPortfolioChanged={this.portfolioChanged} timeout={this.state.timeout}>
	            ...
	            <div className="main-content">
	              ...
	              { this.state.transactions.length === 0 ? "" : <Select
	                ...
	                /> }
	              <DateFilters hide={this.toggleDates} showing={this.state.showDates} selectHeader="Or select range" onRelative={this.toRelativeDate} onAbsolute={this.toDate} range={true} relativePrefix="last " header="View transactions for" />
