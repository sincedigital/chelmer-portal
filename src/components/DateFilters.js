				 ...
				 <div className={outerClassName}>
				  <div className="Dates">
				   <div className="DatesContainer">
		            <div className="DatesClose fg-d" onClick={this.props.hide}>&times;</div>
				    ...
				    <div className="DatesCalendar">
				     ...
				     <div className="calendar-outer">
				      <Calendar value={this.props.range ? null : (this.props.selectedDate || new Date())} locale="en-NZ" maxDate={new Date()} nextLabel={nextIcon} next2Label={next2Icon} prevLabel={prevIcon} prev2Label={prev2Icon} onChange={this.props.onAbsolute} selectRange={this.props.range} returnValue={this.props.range ? "range" : "start"} />" +
				     </div>
		            </div>
	               </div>
		          </div>
