...
class Navigation extends Component {
	...
	render() {
		...
		return (
				<div>
			<div id="MobileNav">
				<img src="images/SinceDigital-Cropped.png" style={{marginTop: "4px"}} width="202" className="nav-logo-mobile" />
			...
			<div data-collapse="small" data-animation="default" data-duration="400" className={navClass}>
			    <div className="nav-container w-container">
			      ...
			      <img alt="" src="images/SinceDigital-White-Transp.png" style={{marginTop: "10px"}} width="250" className="nav-logo"/>
